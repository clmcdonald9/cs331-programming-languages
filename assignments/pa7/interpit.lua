...
function interpit.interp(ast, state, util)
    ...
    function interp_stmt(ast)
        ...
        elseif ast[1] == DEC_STMT or ast[1] == INC_STMT then
            assert(#ast == 2)
            local change

            if ast[1] == INC_STMT then
                change = 1
            else
                change = -1
            end
            ...
            if ast[2][1] == SIMPLE_VAR then
                ...
                if state.v[varname] == nil then
                    state.v[varname] = change

                else
                    state.v[varname] = state.v[varname] + change
                end
            ...
            elseif ast[2][1] == ARRAY_VAR then
                ...
                if state.a[arrayname][index] == nil then
                    state.a[arrayname][index] = change

                else
                    state.a[arrayname][index] = state.a[arrayname][index] + change
                end
    ...
    function eval_expr(ast)
        ...
        elseif ast[1] == ARRAY_VAR then
            ...
            if state.a[arrayname] == nil then
                ...
                result = state.a[arrayname][index]
                if result == nil then
                    result = 0
                end
            end
